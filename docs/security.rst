...
an activation token generated by django-registration's HMAC workflow
should not be usable for attacks against other HMAC-carrying values
generated by the same installation of Django.
