...
**What versions of Django and Python are supported?**
    ...
    supported, on Python 2.7, 3.2, 3.3, 3.4 or 3.5 (though note that
    Django 1.9 drops support for Python 3.2 and 3.3, and many
    libraries which support Python 3 do not support Python 3.2, and
    the next released version of ``django-registration`` will drop
    Python 3.2 support).
